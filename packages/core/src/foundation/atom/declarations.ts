...
const imageValid = (attrs: Attrs) => typeof attrs.alt === "string" && positiveDimensions(attrs) && Boolean(sanitizeAtomSource(String(attrs.src || ""), { kind: "image", allowBlobPreview: attrs.status === "pending" }));
