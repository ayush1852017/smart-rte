...
export { LegacyClassicEditor } from './components/ClassicEditor.js'
export { canonicalAuthorityFlag } from './canonicalAuthorityFlag.js'
export type { CanonicalAuthorityContext, CanonicalAuthorityFlagSnapshot } from './canonicalAuthorityFlag.js'
