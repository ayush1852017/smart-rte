...
*(Sections below are appended as the remaining Phase 8b closeout work — the inline and list rollback bridges, the LegacyClassicEditor cleanup pass, and final verification numbers — is completed.)*
